var assetsLoaded = 0;
var assets = {
  '/webapp/#{path}wiconnect.css': {pos: 'head', tag: 'link', attrs: {rel: 'stylesheet', type: 'text/css', href: '/webapp/#{path}wiconnect.css'}, attempt: 1},
  '/webapp/#{path}wiconnect.js': {pos: 'body', tag: 'script', attrs: { type: 'text/javascript', src: '/webapp/#{path}wiconnect.js'}, attempt: 1}
};
